import abc
from ._compat import collections_abc as collections_abc
from .helpers import is_ip as is_ip, total_seconds as total_seconds
from .json.tag import TaggedJSONSerializer as TaggedJSONSerializer
from typing import Any, Optional
from werkzeug.datastructures import CallbackDict

class SessionMixin(collections_abc.MutableMapping, metaclass=abc.ABCMeta):
    @property
    def permanent(self): ...
    @permanent.setter
